...
public abstract class AbstractScreen implements Screen {
	...
	private static final int SCREEN_WIDTH = OPTION_GAME.SCREEN_WIDTH;
	private static final int SCREEN_HEIGHT = OPTION_GAME.SCREEN_HEIGHT;
	...
	public AbstractScreen(Game _game, String _nameScreen) {
		...
		Gdx.app.log(nameScreen, "Cấu trúc của " + nameScreen);
		
		setUpScreenElement();
	}
	
	// Thiết lập giao diện riêng
	...
	public void setBackground(TextureRegion fileBackGround) {
		...
		Gdx.app.log(nameScreen, "Thiết lập background");
	}
	...
	public void setBackButton(boolean _isBackButtonActive) {
		...
		Gdx.app.log(nameScreen, "Thiết lập nút back có được bật không");
	}
	...
	public void dispose() {
		...
		stage.dispose();
		Gdx.app.log(nameScreen, "Giải phóng thoát khỏi " + nameScreen);
	}
